...
def resnet50(pretrained=False, progress=True, device='cpu', **kwargs):
    return _resnet('resnet50', BasicBlock, [3, 4, 6, 3], pretrained, progress, device,
                   **kwargs)

def resnet101(pretrained=False, progress=True, device='cpu', **kwargs):
    return _resnet('resnet101', BasicBlock, [3, 4, 23, 3], pretrained, progress, device,
                   **kwargs)

def resnet152(pretrained=False, progress=True, device='cpu', **kwargs):
    return _resnet('resnet152', BasicBlock, [3, 4, 36, 3], pretrained, progress, device,
                   **kwargs)